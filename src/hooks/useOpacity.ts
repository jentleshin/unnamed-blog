    ...
    if (!sharedObserver) {
        sharedObserver = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                ...
                targetElement.dispatchEvent(new CustomEvent('intersectChange', { detail: isIntersecting }));
            });
        }, {
...
export const useOpacity =  <T extends HTMLElement>(): [React.RefObject<T>, boolean] => {
