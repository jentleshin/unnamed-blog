...
import { combineClasses, combineRefs } from "../../utils/utils";
...
const Header = ( { children } :IProps ) => {
    ...
    return  (
        <>
            <div ref={combineRefs(ref)} className={combineClasses("sticky top-0 z-20", opacity ? "opacity-1":"opacity-0", "transition-opacity ease-in-out duration-500")}>
