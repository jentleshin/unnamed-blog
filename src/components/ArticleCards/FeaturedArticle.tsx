  ...
  return (
    <>
      ...
      >
        <div
          className={
            "w-full md:w-[75%] lg:px-[50px] px-[15px] lg:py-[30px] py-[20px]"
          }
        >
          ...
          <Text
            token
            className={combineClasses(classes.featured_article__date, "mt-2")}
          >
            {article.date}
          </Text>
        </div>
        ...
        >
          ...
          <img
            ...
            alt={article.articleTitle}
            className="absolute top-0 left-0 w-full h-full object-cover opacity-0 group-hover:opacity-80 transition-all ease-in-out duration-500"
          />
        </div>
      </LinkTo>
    </>
